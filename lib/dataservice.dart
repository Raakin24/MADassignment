...
class Shops {
  ...
  String imageName = "";
  String pathName = "";
  Shops(this.shopName, this.shopLocation, this.imageName, this.pathName);
}
...
class DataService {
  ...
  static final CollectionReference itemData2 = FirebaseFirestore.instance
      .collection('menu2data');

  static final CollectionReference shopData = FirebaseFirestore.instance
      .collection('shopdata');

  static final CollectionReference paymentData = FirebaseFirestore.instance
  ...
  static Future<void> getItemData2() async {
    localItemData2.clear();
    final qs = await itemData2.get();
